...
(lib.bannerImage = function() {
	this.initialize(img.bannerImage);
...
(lib.title = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Image optimization drives better online engagement.", "normal 400 16px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(0,0,160,64.3);
...
(lib.sub = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Regardless of connection speed \nor screen size, you can now deliver quality images lighter, faster with Akamai.", "normal 400 14px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(0,0,158,115.7);
...
(lib.image = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.bannerImage();
...
// stage content:
(lib.Akamai300x250set1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(87,176.9,1,1,0,0,0,79,57.9);
	...
	// photo-1
	this.instance_8 = new lib.image("synched",0);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/bannerImage.jpg", id:"bannerImage"}
	],
	preloads: []
};
