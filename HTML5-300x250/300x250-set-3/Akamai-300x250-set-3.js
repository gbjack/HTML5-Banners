...
(lib.title = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Want to\neliminate costs\nfrom image\nresizing?", "normal 400 16px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(0,0,119,82.4);
...
(lib.sub = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Image optimization for multiple platforms is both expensive and labor intensive. \nHere’s a solution \nfor you!", "normal 400 14px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(0,0,158,100.6);
...
// stage content:
(lib.Akamai300x250set3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// photo-1
	this.instance_8 = new lib.bgimg("synched",0);
