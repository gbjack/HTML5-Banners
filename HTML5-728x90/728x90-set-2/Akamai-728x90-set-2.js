...
(lib.Sub1x = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Akamai has a simple way to optimize your website and deliver the right image to each of your user. Find out now.", "normal 400 14px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(-191.8,-20.1,401.8,40.2);
...
(lib.Font1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Have high-quality website images but low impact performance?", "normal 400 19px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(0,0,325,47.8);
...
// stage content:
(lib.Akamai728x90set2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// sub-1
	this.instance_1 = new lib.Sub1x("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(327.8,47.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(54).to({_off:false},0).to({alpha:1},10).wait(16));

	// Font-1
	this.instance_2 = new lib.Font1("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(316.9,50,1,1,0,0,0,157.5,27.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(35).to({_off:false},0).to({alpha:1},14).to({startPosition:0},1).to({alpha:0},8).to({_off:true},1).wait(21));

	// logo
	this.instance_3 = new lib.logosvg("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(57.9,45.1,1,1,0,0,0,44.5,18.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(26).to({_off:false},0).to({x:69.9,alpha:1},13).wait(41));

	// pattern
	this.instance_4 = new lib.pattern_1svg("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(272.2,44.6,1,1,0,0,0,409.7,199.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({_off:false},0).to({alpha:1},7).wait(54));

	// 3
	this.instance_5 = new lib._1("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-309.1,38.6,1,1,0,0,0,397.4,195.4);
	this.instance_5.alpha = 0.699;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(9).to({_off:false},0).to({x:199.8},10,cjs.Ease.get(1)).wait(61));

	// 2
	this.instance_6 = new lib._1("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-315.9,37.6,1,1,0,0,0,407,195.2);
	this.instance_6.alpha = 0.5;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).to({x:238},10,cjs.Ease.get(1)).wait(66));

	// 1
	this.instance_7 = new lib._1("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-288.7,37.6,1,1,0,0,0,416.2,195.2);
	this.instance_7.alpha = 0.301;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:266.2},9,cjs.Ease.get(1)).wait(71));

	// photo-1
	this.instance_8 = new lib.pix2("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(334,45,1,1,0,0,0,364,45);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(23).to({_off:false},0).to({x:364,alpha:1},6,cjs.Ease.get(1)).wait(51));
