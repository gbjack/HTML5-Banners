...
(lib.Sub1x = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Image optimization for multiple platforms is both expensive and labor intensive. Here’s a solution for you!", "normal 400 14px 'Ubuntu'", "#FFFFFF");
...
(lib.Font1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("Want to eliminate costs from image resizing?", "normal 400 18px 'Ubuntu'", "#FFFFFF");
...
p.nominalBounds = new cjs.Rectangle(0,0,428,32.6);
...
// stage content:
(lib.Akamai728x90set3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_2.setTransform(297.5,60.2,1,1,0,0,0,157.5,27.6);
	...
	// photo-1
	this.instance_8 = new lib.bgimage_1("synched",0);
